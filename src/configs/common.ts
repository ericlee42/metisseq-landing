...
export const graphUrl = {
  staking: {
    [mainnet.id.toString()]: 'https://subgraph.satsuma-prod.com/b91d46e5018b/metis/metis-sequencer-locking/version/v0.0.3/api',
    [holesky.id.toString()]: 'https://graphnode.holesky.metisdevops.link/subgraphs/name/metisio/sequencer-locking',
    [sepolia.id.toString()]: 'https://subgraph.satsuma-prod.com/metis/metis-sepolia-sequencer-locking/version/v0.0.3/api',
  },
  block: {
