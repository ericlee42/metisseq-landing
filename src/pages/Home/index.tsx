  ...
  return (
    <div className={`${ifMobile ? 'flex-col gap-16 items-center' : 'flex-row gap-32 items-start'} flex wrap maxw-520`}>
      ...
      <div className={`${ifMobile ? 'items-center gap-8' : 'gap-6'} flex flex-col`}>
        ...
        {content ? <span className={`${ifMobile ? 'align-center' : ''} fz-18 fw-400 inter color-fff`}>{content}</span> : null}
      </div>
    </div>
  );
};
...
export function Component() {
  ...
  return (
    <Container className={'pages-landing flex flex-col'}>
      ...
      <div className={`main-section main-section-2 flex flex-col gap-22 justify-center  ${ifMobile ? 'p-22 pt-48 pb-91' : 'h-791'}`}>
        <div className="flex flex-col gap-12 items-center">
          <span className={`${ifMobile ? 'fz-40' : 'fz-56'} fw-700 color-fff raleway`}>{section2.title}</span>
        </div>
        <div className={`${ifMobile ? 'flex-col gap-45' : 'flex-row gap-18'} flex items-center items-center justify-center`}>
      ...
      {/* Sequencer */}
      <div className={`sc3 main-section main-section-3 flex flex-col gap-56 pt-127 pb-152 ${ifMobile ? 'pl-22 pr-22' : ''}`}>
        ...
        <div className="flex flex-col items-center">
          <div className="position-relative">
            ...
            <img style={ifMobile ? { objectFit: 'cover' } : {}} className={`${ifMobile ? 'w-full h-452 radius-30' : 'w-784'}`} src={ifMobile ? getImageUrl('@/assets/images/_global/m_Decentralized_Sequencer.png') : getImageUrl('@/assets/images/_global/Decentralized_Sequencer.png')} />
          </div>
        </div>
      </div>

      {/* waitinglist campagin */}
      <div className={`sc4 main-section main-section-4 flex flex-col items-center gap-64 pt-97 pb-121 ${ifMobile ? 'pl-22 pr-22' : ''}`}>
        <div className="flex flex-col gap-12 items-center">
      ...
      {/* FAQ */}
      <div className={`sc5 main-section flex ${ifMobile ? 'mobile pl-22 pr-22 items-start flex-col gap-33 maxwp-100' : 'items-center flex-row gap-64 maxw-1200'} pt-91 pb-54 m-auto`}>
